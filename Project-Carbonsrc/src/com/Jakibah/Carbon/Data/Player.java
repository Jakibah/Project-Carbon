...
public static void Walk(){
	...
	if(Direction == 0 && Moving == true ){
		System.out.println("Walking North");
		  getPlayers().get(0).setY(y -= speed * Time.getDelta());
		}
	if(Direction == 1 && Moving == true ){
		System.out.println("Walking East");
		getPlayers().get(0).setX(x += speed * Time.getDelta());
...
public static void Inputs(){
    ...
    public static void draw(){
    	Draw.DrawQuadTex(Draw.QuickLoadTexture(tex, null), x, y, width, height);
    }
